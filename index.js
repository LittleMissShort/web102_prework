...
const descriptionText = ` So far, $${totalRaised.toLocaleString("en-US")} has been raised for ${GAMES_JSON.length} games.
${numUnfunded === 1 ? "1 game remains" : `${numUnfunded} games remain`} unfunded.`;
